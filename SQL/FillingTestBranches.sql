...
SELECT newid() as [CompanyID],'TEST_BRANCH' as [CompanyName],[Email],[Phone],[Fax],[State],[City],[ZipCode],[Address],[Address],[GeoLat],[GeoLon],[IsEnabled],'2019-04-17 23:44:34.370' as [CreatedDate],null as [ModifiedDate],[CreatedBy],[ModifiedBy],[CompanyID]
